...
var data = '<h1>Privacy Policy</h1>' +
    '<p>Last updated: May 22, 2021</p>' +
    ...
    '</li>' +
    '<li>' +
    '<p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Thispensa</p>' +
    '</li>' +
    '<li>' +
    '<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Thispensa.</p>' +
    '</li>' +
    '<li>' +
    ...
    '<ul>' +
    '<li>By email: a.abellonio.0734@vallauri.edu</li>' +
    '</ul>';
